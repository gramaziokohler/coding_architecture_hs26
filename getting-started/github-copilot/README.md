...
Once the academic discount is approved, you can [enable Github Copilot on this link](https://github.com/github-copilot/free_signup). After that, you can start using Copilot. One of the most practical ways to integrate it is directly in the Visual Studio Code IDE, it basically comes down to installing the Copilot extension and logging in to your Github, but you can [find more information on this link](https://docs.github.com/en/copilot/using-github-copilot/getting-code-suggestions-in-your-ide-with-github-copilot).
